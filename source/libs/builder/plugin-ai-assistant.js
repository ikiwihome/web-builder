$("#select-actions #edit-code-btn").after('<a id="ai-assistant-btn" href="" title="AI小助手 (由OpenAI ChatGPT3.5提供支持)"><i class="icon-color-wand"></i></a>');
...
<div class="response">
	<div class="content">
		...
		<div class="card">
		  <div class="card-body">
			<h5 class="card-title">欢迎访问本网站!</h5>
			<p class="card-text">感谢您访问我们的网站。我们希望您能找到您需要的一切.</p>
	...
	<div class="ai-actions">
		<button type="button" class="btn btn-sm btn-outline-primary btn-insert"><i class="icon-arrow-up"></i>插入内容</button>
		<button type="button" class="btn btn-sm btn-outline-primary btn-replace"><i class="icon-swap-horizontal-outline"></i> 替换元素</button>
	</div>
</div>	
`;
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <p class="modal-title text-primary"><i class="icon-color-wand"></i> AI小助手 (由OpenAI ChatGPT3.5提供支持)</p>
      ...
      <div class="modal-body">
	    ...
	    <button type="button" class="btn btn-success btn-ask-ai"><i class="icon-color-wand la-lg"></i> 发送问题</button>
	    <button type="button" class="btn btn-light border btn-insert-content"><i class="icon-arrow-up la-lg"></i> 插入元素内容</button>
      ...
      <div class="modal-footer">
        <!-- <button type="button" class="btn btn-primary btn-lg btn-save" data-bs-dismiss="modal"><i class="la la-save"></i> 保存</button> -->
        <button type="button" class="btn btn-secondary btn-lg close-btn" data-bs-dismiss="modal"><i class="la la-times"></i> 关闭</button>
      </div>
    </div>
  </div>
</div>
...
function aiAssistantSendQuery() {
	if (!chatgptOptions["key"]) {
		displayToast("bg-danger", "Error", '未配置 ChatGPT API Key！在插件设置页面中输入有效的API Key.');
		return;
	}
	...
	const ChatGPT = {
		...
		messages: [
		  ...
		  {
			role: "system",
			content: "您是 Bootstrap 5 Html 专家，我问你的任何问题都使用中文回答。"
		  },
		],
		*/
	...
	fetch("https://openai-2zn.pages.dev/api/v1/completions", {
		method: "POST",
		headers: {
