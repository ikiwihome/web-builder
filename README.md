...
## [Live Demo](https://web.ikiwi.cc)

For a full featured Open Source CMS using Web page builder check [Vvveb CMS](https://github.com/givanz/Vvveb)
...
```bash
#git 2.13+ 
git clone --recurse-submodules https://github.com/ikiwihome/web-builder

# older git versions 
git clone --recursive https://github.com/ikiwihome/web-builder
```
...
``` bash
docker run -d --name web-builder -h web-builder --restart=unless-stopped -e TZ="Asia/Shanghai" ikiwicc/web-builder:latest
```
